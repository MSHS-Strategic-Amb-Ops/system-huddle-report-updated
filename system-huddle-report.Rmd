...
# hh_data_comp_raw_pt_entry_old <- dbGetQuery(con_hh, "SELECT * FROM qidm_prod.dbo.PT_AMB_HAND_HYGIENE_COMP")
...
print(hh_data_comp_raw_pt_entry)
...
hh_data_merged <- hh_data_comp %>%
  ...
  mutate(date = as.Date(date, "%m/%d/%Y"),
         Appt.Year = as.numeric(format(as.Date(date, "%m/%d/%Y"),"%Y")),
