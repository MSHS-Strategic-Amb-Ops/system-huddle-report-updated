...
#   group_by(SITE, DEPT_SPECIALTY_NAME, DEPARTMENT_NAME, DEPARTMENT_ID, DEP_RPT_GRP_ELEVEN, Appt.Year, Appt.MonNum, VISIT_METHOD, VISIT_GROUP_NUM, FINCLASS, PATIENT_CLASS) %>%
#   summarise(total = n()) %>%
#   collect()
#
# volume_new <- volume %>%
...
#
# require(openxlsx)
# write.xlsx(rad_radOnc_data_new, "RIS and MOSAIC Jan19Nov24.xlsx")
```
